Feature: Add book
  ...
  Scenario Outline: Add a book when the administrator is logged in
    ...
    Examples:
      ...
      | Test-Drivenest Driven Development | Kent Beck               | 9780321146533 | Beck2002     | Aya_Abu3li    | 123456   |
      | The Paris Library                 | Janet Skeslien Charles  | 9781982134198 | Charles2002  | Waseem_ghazal | 12356    |
